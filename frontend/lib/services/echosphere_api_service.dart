...
class EchosphereApiService {
  ...
  static const Map<String, Map<String, String>> _kCampusDict = {
    'kn': {
      'internal assessment': 'à²†à²‚à²¤à²°à²¿à²• à²®à³Œà²²à³à²¯à²®à²¾à²ªà²¨',
      'examination': 'à²ªà²°à³€à²•à³à²·à³†',
      'exam schedule': 'à²ªà²°à³€à²•à³à²·à²¾ à²µà³‡à²³à²¾à²ªà²Ÿà³à²Ÿà²¿',
      'exam': 'à²ªà²°à³€à²•à³à²·à³†',
      'schedule': 'à²µà³‡à²³à²¾à²ªà²Ÿà³à²Ÿà²¿',
      'students': 'à²µà²¿à²¦à³à²¯à²¾à²°à³à²¥à²¿à²—à²³à³',
      'department': 'à²µà²¿à²­à²¾à²—',
      'holiday': 'à²°à²œà³†',
      'circular': 'à²¸à³à²¤à³à²¤à³‹à²²à³†',
      'notice': 'à²¸à³‚à²šà²¨à³†',
      'workshop': 'à²•à²¾à²°à³à²¯à²¾à²—à²¾à²°',
      'seminar': 'à²µà²¿à²šà²¾à²° à²¸à²‚à²•à²¿à²°à²£',
      'fee payment': 'à²¶à³à²²à³à²• à²ªà²¾à²µà²¤à²¿',
      'fees': 'à²¶à³à²²à³à²•à²—à²³à³',
      'placement': 'à²‰à²¦à³à²¯à³‹à²—à²¾à²µà²•à²¾à²¶',
      'placement drive': 'à²•à³à²¯à²¾à²‚à²ªà²¸à³ à²¸à²‚à²¦à²°à³à²¶à²¨',
      'auditorium': 'à²¸à²­à²¾à²‚à²—à²£',
      'room': 'à²•à³Šà² à²¡à²¿',
      'lab': 'à²ªà³à²°à²¯à³‹à²—à²¾à²²à²¯',
      'attendance': 'à²¹à²¾à²œà²°à²¾à²¤à²¿',
      'mandatory': 'à²•à²¡à³à²¡à²¾à²¯à²µà²¾à²—à²¿à²¦à³†',
      'deadline': 'à²•à³Šà²¨à³†à²¯ à²¦à²¿à²¨à²¾à²‚à²•',
      'submit': 'à²¸à²²à³à²²à²¿à²¸à²¿',
      'closed': 'à²®à³à²šà³à²šà²¿à²°à³à²¤à³à²¤à²¦à³†',
      'classes suspended': 'à²¤à²°à²—à²¤à²¿à²—à²³à²¨à³à²¨à³ à²°à²¦à³à²¦à³à²—à³Šà²³à²¿à²¸à²²à²¾à²—à²¿à²¦à³†',
    },
    'hi': {
      'internal assessment': 'à¤†à¤‚à¤¤à¤°à¤¿à¤• à¤®à¥‚à¤²à¥à¤¯à¤¾à¤‚à¤•à¤¨',
      'examination': 'à¤ªà¤°à¥€à¤•à¥à¤·à¤¾',
      'exam schedule': 'à¤ªà¤°à¥€à¤•à¥à¤·à¤¾ à¤…à¤¨à¥à¤¸à¥‚à¤šà¥€',
      'exam': 'à¤ªà¤°à¥€à¤•à¥à¤·à¤¾',
      'schedule': 'à¤¸à¤®à¤¯ à¤¸à¤¾à¤°à¤¿à¤£à¥€',
      'students': 'à¤›à¤¾à¤¤à¥à¤°à¥‹à¤‚',
      'department': 'à¤µà¤¿à¤­à¤¾à¤—',
      'holiday': 'à¤…à¤µà¤•à¤¾à¤¶',
      'circular': 'à¤ªà¤°à¤¿à¤ªà¤¤à¥à¤°',
      'notice': 'à¤¸à¥‚à¤šà¤¨à¤¾',
      'workshop': 'à¤•à¤¾à¤°à¥à¤¯à¤¶à¤¾à¤²à¤¾',
      'seminar': 'à¤¸à¤‚à¤—à¥‹à¤·à¥à¤ à¥€',
      'fee payment': 'à¤¶à¥à¤²à¥à¤• à¤­à¥à¤—à¤¤à¤¾à¤¨',
      'fees': 'à¤¶à¥à¤²à¥à¤•',
      'placement': 'à¤ªà¥à¤²à¥‡à¤¸à¤®à¥‡à¤‚à¤Ÿ',
      'placement drive': 'à¤•à¥ˆà¤‚à¤ªà¤¸ à¤ªà¥à¤²à¥‡à¤¸à¤®à¥‡à¤‚à¤Ÿ à¤¡à¥à¤°à¤¾à¤‡à¤µ',
      'auditorium': 'à¤¸à¤­à¤¾à¤—à¤¾à¤°',
      'room': 'à¤•à¤®à¤°à¤¾',
      'lab': 'à¤ªà¥à¤°à¤¯à¥‹à¤—à¤¶à¤¾à¤²à¤¾',
      'attendance': 'à¤‰à¤ªà¤¸à¥à¤¥à¤¿à¤¤à¤¿',
      'mandatory': 'à¤…à¤¨à¤¿à¤µà¤¾à¤°à¥à¤¯',
      'deadline': 'à¤…à¤‚à¤¤à¤¿à¤® à¤¤à¤¿à¤¥à¤¿',
      'submit': 'à¤œà¤®à¤¾ à¤•à¤°à¥‡à¤‚',
      'closed': 'à¤¬à¤‚à¤¦ à¤°à¤¹à¥‡à¤—à¤¾',
      'classes suspended': 'à¤•à¤•à¥à¤·à¤¾à¤à¤‚ à¤¨à¤¿à¤²à¤‚à¤¬à¤¿à¤¤',
    },
    'te': {
      'internal assessment': 'à°…à°‚à°¤à°°à±à°—à°¤ à°…à°‚à°šà°¨à°¾',
      'examination': 'à°ªà°°à±€à°•à±à°·',
      'exam schedule': 'à°ªà°°à±€à°•à±à°·à°² à°·à±†à°¡à±à°¯à±‚à°²à±',
      'exam': 'à°ªà°°à±€à°•à±à°·',
      'schedule': 'à°·à±†à°¡à±à°¯à±‚à°²à±',
      'students': 'à°µà°¿à°¦à±à°¯à°¾à°°à±à°¥à±à°²à±',
      'department': 'à°µà°¿à°­à°¾à°—à°‚',
      'holiday': 'à°¸à±†à°²à°µà±',
      'circular': 'à°¸à°°à±à°•à±à°¯à±à°²à°°à±',
      'notice': 'à°¨à±‹à°Ÿà±€à°¸à±',
      'workshop': 'à°µà°°à±à°•à±â€Œà°·à°¾à°ªà±',
      'seminar': 'à°¸à±†à°®à°¿à°¨à°¾à°°à±',
      'fee payment': 'à°«à±€à°œà± à°šà±†à°²à±à°²à°¿à°‚à°ªà±',
      'fees': 'à°«à±€à°œà±à°²à±',
      'placement': 'à°ªà±à°²à±‡à°¸à±â€Œà°®à±†à°‚à°Ÿà±',
      'placement drive': 'à°•à±à°¯à°¾à°‚à°ªà°¸à± à°ªà±à°²à±‡à°¸à±â€Œà°®à±†à°‚à°Ÿà± à°¡à±à°°à±ˆà°µà±',
      'auditorium': 'à°†à°¡à°¿à°Ÿà±‹à°°à°¿à°¯à°‚',
      'room': 'à°—à°¦à°¿',
      'lab': 'à°ªà±à°°à°¯à±‹à°—à°¶à°¾à°²',
      'attendance': 'à°¹à°¾à°œà°°à±',
      'mandatory': 'à°¤à°ªà±à°ªà°¨à°¿à°¸à°°à°¿',
      'deadline': 'à°šà°¿à°µà°°à°¿ à°¤à±‡à°¦à±€',
      'submit': 'à°¸à°®à°°à±à°ªà°¿à°‚à°šà°‚à°¡à°¿',
      'closed': 'à°®à±‚à°¸à°¿à°µà±‡à°¯à°¬à°¡à±à°¤à±à°‚à°¦à°¿',
      'classes suspended': 'à°¤à°°à°—à°¤à±à°²à± à°°à°¦à±à°¦à± à°šà±‡à°¯à°¬à°¡à±à°¡à°¾à°¯à°¿',
    },
    'ta': {
      'internal assessment': 'à®‰à®³à¯ à®®à®¤à®¿à®ªà¯à®ªà¯€à®Ÿà¯',
      'examination': 'à®¤à¯‡à®°à¯à®µà¯',
      'exam schedule': 'à®¤à¯‡à®°à¯à®µà¯ à®…à®Ÿà¯à®Ÿà®µà®£à¯ˆ',
      'exam': 'à®¤à¯‡à®°à¯à®µà¯',
      'schedule': 'à®…à®Ÿà¯à®Ÿà®µà®£à¯ˆ',
      'students': 'à®®à®¾à®£à®µà®°à¯à®•à®³à¯',
      'department': 'à®¤à¯à®±à¯ˆ',
      'holiday': 'à®µà®¿à®Ÿà¯à®®à¯à®±à¯ˆ',
      'circular': 'à®šà¯à®±à¯à®±à®±à®¿à®•à¯à®•à¯ˆ',
      'notice': 'à®…à®±à®¿à®µà®¿à®ªà¯à®ªà¯',
      'workshop': 'à®ªà®¯à®¿à®²à®°à®™à¯à®•à®®à¯',
      'seminar': 'à®•à®°à¯à®¤à¯à®¤à®°à®™à¯à®•à¯',
      'fee payment': 'à®•à®Ÿà¯à®Ÿà®£à®®à¯ à®šà¯†à®²à¯à®¤à¯à®¤à¯à®¤à®²à¯',
      'fees': 'à®•à®Ÿà¯à®Ÿà®£à®®à¯',
      'placement': 'à®µà¯‡à®²à¯ˆà®µà®¾à®¯à¯à®ªà¯à®ªà¯',
      'placement drive': 'à®µà®³à®¾à®• à®µà¯‡à®²à¯ˆà®µà®¾à®¯à¯à®ªà¯à®ªà¯ à®®à¯à®•à®¾à®®à¯',
      'auditorium': 'à®…à®°à®™à¯à®•à®®à¯',
      'room': 'à®…à®±à¯ˆ',
      'lab': 'à®†à®¯à¯à®µà®•à®®à¯',
      'attendance': 'à®µà®°à¯à®•à¯ˆ',
      'mandatory': 'à®•à®Ÿà¯à®Ÿà®¾à®¯à®®à¯',
      'deadline': 'à®•à®Ÿà¯ˆà®šà®¿ à®¤à¯‡à®¤à®¿',
      'submit': 'à®šà®®à®°à¯à®ªà¯à®ªà®¿à®•à¯à®•à®µà¯à®®à¯',
      'closed': 'à®®à¯‚à®Ÿà®ªà¯à®ªà®Ÿà¯à®®à¯',
      'classes suspended': 'à®µà®•à¯à®ªà¯à®ªà¯à®•à®³à¯ à®°à®¤à¯à®¤à¯ à®šà¯†à®¯à¯à®¯à®ªà¯à®ªà®Ÿà¯à®Ÿà¯à®³à¯à®³à®©',
    },
  };

  static const Map<String, Map<String, String>> _kLangMeta = {
    'kn': {'name': 'Kannada', 'native': 'à²•à²¨à³à²¨à²¡', 'prefix': 'à²¸à³‚à²šà²¨à³†:'},
    'hi': {'name': 'Hindi', 'native': 'à¤¹à¤¿à¤‚à¤¦à¥€', 'prefix': 'à¤¸à¥‚à¤šà¤¨à¤¾:'},
    'te': {'name': 'Telugu', 'native': 'à°¤à±†à°²à±à°—à±', 'prefix': 'à°¨à±‹à°Ÿà±€à°¸à±:'},
    'ta': {'name': 'Tamil', 'native': 'à®¤à®®à®¿à®´à¯', 'prefix': 'à®…à®±à®¿à®µà®¿à®ªà¯à®ªà¯:'},
  };
